...
const Features = () => {
    return (
        <section className="py-5 md:py-10">
            ...
            <P className="text-center my-4 max-w-[98%] md:max-w-[40%] mx-auto">{"Explore the essential tools designed to streamline your workflows, enhance team collaboration, and ensure your projects run smoothly from start to finish"}</P>
